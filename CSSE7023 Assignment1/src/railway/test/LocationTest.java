...
public class LocationTest {
    ...
    /** Customised check of the equals method */
    @Test
    ...
    /** Customised check of the onSection method */
    @Test
    public void testOnSection() {
        JunctionBranch endPoint1 =
                new JunctionBranch(new Junction("j1"), Branch.FACING);
        JunctionBranch endPoint2 =
                new JunctionBranch(new Junction("j2"), Branch.NORMAL);
        ...
        JunctionBranch endPoint4 =
                new JunctionBranch(new Junction("j3"), Branch.FACING); 
        JunctionBranch endPoint5 =
                new JunctionBranch(new Junction("j4"), Branch.FACING);
        Section section1 = new Section(9, endPoint1, endPoint2);
        Section section2 = new Section(12, endPoint4, endPoint3);
        Section section3 = new Section(12, endPoint5, endPoint4);
        Location location1 = new Location(section1, endPoint1, 0);
        Assert.assertTrue(location1.onSection(section1));
        Assert.assertTrue(location1.onSection(section2));
        Assert.assertFalse(location1.onSection(section3));
